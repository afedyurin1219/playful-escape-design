...
const Auth = () => {
  ...
  const onSignupSubmit = (data: SignupFormValues) => {
    signUp(data.email, data.password, { name: data.name });
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-ivory p-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          <a href="/" className="text-3xl font-display text-teal inline-block">
            Escape Room Designer
          </a>
          <p className="text-charcoal-light mt-2">Sign in to manage your escape room projects</p>
        </div>
